...
if (process.argv.length <= 2) {
    ...
    console.log(color.brightBlue(`
                        ...
                        ·▀▀▀  ▀█▄▀▪.▀    ▀ ·▀▀▀ • ▀█▄▀▪.▀▀▀   ▀ •     ▀▀ █▪ ▀▀▀  ▀▀▀ 
        `));
    console.log('                                           t.me/Cop_zolyNet'.yellow)
    console.log('  \r\n\nUsage : [Target] [Time] [Threads]')
...
console.log(color.brightBlue(`
        ...
        `));
console.log('                                           t.me/Cop_zolyNet'.yellow)
setTitle(` Cop.zolyNet ll User : [${username}] : Cop.zoly Net - Stresser`);
console.log(`Attack successfully [Info] : 
